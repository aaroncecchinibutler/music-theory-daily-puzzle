      ...
      {copied ? '✓ Copied!' : (
        <>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{marginRight: 6, verticalAlign: 'middle'}}>
            <polyline points="8 6 12 2 16 6"/><line x1="12" y1="2" x2="12" y2="15"/>
            <path d="M20 21H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h2"/><path d="M18 10h2a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H4"/>
          </svg>
          Share
        </>
      )}
